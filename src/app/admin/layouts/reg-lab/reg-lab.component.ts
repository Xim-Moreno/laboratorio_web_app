...
@Component({
  ...
  templateUrl: './reg-lab.component.html',
  styleUrls: ['./reg-lab.component.scss']
})
export class RegLabComponent {
  ...
  register() {
    const { number, name, lastname, birth, gender, phone, password, especialidad} = this.myForm.value;

    this.authService.register(number, name, lastname, birth, gender, phone, password, 'laboratorista', especialidad)
      .subscribe({
